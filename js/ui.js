...
var navPages = [
	...
	new NavPage("搜索", "img/bt_search.png", new NavPageAdapter({
		onCreate: function(adapter) {
			adapter.contentLayout=$('<div id="contentLayout" class="contentLayout"><div class="searchBar"><input class="searchInputText" type="search" /><span class="searchButton">搜索</span></div><span class="textAutoWrap"></span></div>')[0];
